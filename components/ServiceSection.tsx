...
const ServiceSection: React.FC<Props> = ({ section, index }) => {
  return (
    ...
    >
      <div className="container mx-auto px-6 md:px-12 grid md:grid-cols-2 gap-6 md:gap-16 items-center">
        <div className={`${index % 2 !== 0 ? 'md:order-2' : ''} order-2`}>
          ...
          >
            <span className="text-[10px] uppercase tracking-[0.6em] text-white/30 mb-6 md:mb-8 block font-bold">
            ...
            <p className="text-sm md:text-base lg:text-lg text-white/50 leading-relaxed mb-8 md:mb-12 font-light max-w-lg mx-auto md:mx-0">
              {section.description}
            </p>
